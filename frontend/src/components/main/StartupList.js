        ...
        <div class="row">
          <div class="col-sm-5">
            <img
              ...
              width="550px\"
              height="300px"
              src="http://localhost:5000/images/logo design.png"
              alt=""
            ></img>
          </div>
          ...
          <div class="col-sm-7">
            <div class="lis">
              ...
              <p>
                A brand which focus on providing gourment spices prepared using
                traditional ways like #Sun-Drying, #Hand-pounding and
                #Hand-sieving
              </p>
              <br />
